...
class GameLoop:
    ...
    def init_level_1(self, reset_player=True):
        ...
        self.add_enemy_to_group("graphics/snake.png", 5000, 529, self.enemy_group, [self.enemy_defeated_by_missile_group])
        ...
        self.add_enemy_to_group("graphics/poison_grapes_sm.png", 1770, 570, self.enemy_group, [])
        ...
        self.add_enemy_to_group("graphics/tree.png", 8000, 100, self.enemy_group, [])
